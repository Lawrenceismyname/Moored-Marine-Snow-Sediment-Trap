...
#define COMPLETE_TIMEOUT_MS       15000   //15 seconds
...
float g_bmp_pres  = NAN;
float g_ds18_temp = NAN;
...
//30 seconds for reasons
  ...
  if (ESP_ON) {
    //Transmitting string
    sendDataUART(g_ds18_temp, g_bmp_pres, -1.00, 
                    (int)vibrated, t.year, t.month, t.day, 
